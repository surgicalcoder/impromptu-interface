...
namespace ImpromptuInterface.Internal
{
    ...
    /// </summary>
    public class InvokeSetters : DynamicObject, ImpromptuInterface.Internal.Support.ICustomTypeProvider
    {
        ...
        public override bool TryInvoke(InvokeBinder binder, object[] args, out object result)
        {
            ...
            else if (args.Length == 2)
            {
                    ...
                    )
                {
                    ...
                    var tInterface = tEnumerableArg.GetType().GetTypeInfo().GetInterface("IEnumerable`1", false);
                    if(tInterface !=null)
                    {
