    ...
    public class ExtensionToInstanceProxy: ImpromptuForwarder
    {
        ...
        public override bool TryGetMember(GetMemberBinder binder, out object result)
        {
            ...
            if (!base.TryGetMember(binder, out result))
            {
                ...
                var tInterface = CallTarget.GetType().GetTypeInfo().GetInterface(_extendedType.Name, false);
                result = new Invoker(binder.Name,
                                     tInterface.GetTypeInfo().IsGenericType ? tInterface.GetGenericArguments() : new Type[] {},null, this);
            }
            return true;
        }
        ...
        protected object InvokeStaticMethod(String_OR_InvokeMemberName name, object[] args)
        {
            ...
            {
                var tInterface = CallTarget.GetType().GetTypeInfo().GetInterface(_extendedType.Name, false);
                var tTypeGenerics = (tInterface.GetTypeInfo().IsGenericType ? tInterface.GetGenericArguments()
