...
namespace ImpromptuInterface.Dynamic
{
    ...
    public class ImpromptuBuilder<TObjectProtoType>: ImpromptuObject, IImpromptuBuilder
    {
        ...
        ///</summary>
        public class BuilderTrampoline:DynamicObject,ImpromptuInterface.Internal.Support.ICustomTypeProvider
        {
        ...
        /// </summary>
        public class SetupTrampoline : DynamicObject, ImpromptuInterface.Internal.Support.ICustomTypeProvider
        {
			ImpromptuBuilder<TObjectProtoType> _buider;
        ...
        public override bool TryInvokeMember(InvokeMemberBinder binder, object[] args, out object result)
        {
            ...
            {
                if (tType.GetTypeInfo().IsInterface && result != null && !tType.IsAssignableFrom(result.GetType()))
                {
